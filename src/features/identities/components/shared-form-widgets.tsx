...
export const TextWidget: React.FC<WidgetProps> = ({ id, value, onChange, onBlur, onFocus, placeholder, disabled, readonly, required, schema, label }) => {
  const theme = useTheme();
...
export const SelectWidget: React.FC<WidgetProps> = ({ id, value, onChange, onBlur, onFocus, disabled, readonly, required, options, label, placeholder }) => {
  const theme = useTheme();
